;; This is my solution for Advent of Code assignment 1 part 1.
;;
;; Beware: these are the first Scheme (and for that matter, Lisp)
;; lines of code I ever wrote. It works, but it can probably solved in
;; better ways.
;;
